            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                      <u> Project:</u> <strong>{{$projecttitle}}</strong>
                  </p>
                            ...
                            <tr>
                                ...
                                <td>
                                  @if ($task->status == 'active')
                                    <a href="{{route('member.update-status', ['id' => preg_replace('/[^a-zA-Z0-9\s]/', '', $task->taskname), 'projecttitle' => $projecttitle])}}" class="btn btn-outline-info btn-sm">Update Status</a>                                    
                                  @endif
                                </td>
                            </tr>
                          @endforeach                        
